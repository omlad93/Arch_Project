...
add,  $r3, $zero, $imm, 12        # 1: R3 = 12 constant    MAYBE DONT NEED 
add,  $r4, $zero, $imm, 4        # 2: R4 = 4 constant 
add,  $r5, $zero, $zero, 0       # 3: R5 = 0     (l)
add,  $r6, $zero, $imm, 12       # 4: R6 = 12     (i)             START FOR LOOP L
...
blt,  $imm, $r6, $r2, 6          #24: if(R6 < R2 ) (i < 16) -> go to start of for loop i 
