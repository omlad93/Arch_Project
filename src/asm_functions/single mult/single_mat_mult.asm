# based on the code from cache opt lecture
...
blt, 1, 9, 2, W         # 6: if(R9<R2) (jj+B < N)          CHANGE W 
...
blt, 1, 10, 2, L        # 11: if(R10<R2) (kk+B < N)          CHANGE L 
...
blt, 1, 6, 9, E         # 26: if(R6 < R9 ) (j < min(jj+B,N)) -> got to start of for j 
add, 0, 0, 0, 0         # 27: DOING NOTHING 

add, 5, 5, 1, 1         # 28: R5 = R5 + 1 ( i++)
blt, 1, 5, 2, T         # 29: if(R5 < R2 ) (i < 16)) -> got to start of for i U
add, 0, 0, 0, 0         # 30: DOING NOTHING 

add, 4, 4, 1, 8         # 31: R4 = R4 + 8 ( kk = kk + 8 )
blt, 1, 4, 2, K         # 32: if(R4 < R2 ) (kk < 16)) -> got to start of for kk K
add, 0, 0, 0, 0         # 33: DOING NOTHING 

add, 3, 3, 1, 8         # 34: R3 = R3 + 8 ( jj = jj + 8 )
blt, 1, 3, 2, T         # 35: if(R3 < R2 ) (jj < 16)) -> got to start of for jj J
